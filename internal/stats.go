...
type Counters struct {
	...
	Delayed  uint64
	Rejected uint64
	DelayOverflowDropped uint64
}
func (c *Counters) IncDelayOverflowDropped() {
	atomic.AddUint64(&c.DelayOverflowDropped, 1)
}
...
func (c *Counters) GetDelayOverflowDropped() uint64 {
	return atomic.LoadUint64(&c.DelayOverflowDropped)
}